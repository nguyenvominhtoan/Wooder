...
function handleLang() {
    ...
    const langItems = document.querySelectorAll('.lang .lang__option .lang__option-item');
...
//popup videp
function popupVideo() {
    let videos = document.querySelectorAll('.video .video__item .video__item-img');
...
function handleTabs() {
    ...
    tabs.forEach(function (tab) {
        tab.addEventListener('click', function (e) {
            ...
            document.querySelector('.news__list-' + id)
